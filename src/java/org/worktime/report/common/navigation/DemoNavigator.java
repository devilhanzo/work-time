...
public class DemoNavigator implements Serializable {
    ...
    private static final String DEMO_VIEW_PARAMETER = "type";
    private static final String SAMPLE_VIEW_PARAMETER = "kind";
    private static final String SEPARATOR = "/";
    private static final String SAMPLE_PREFIX = "-doc";
    private static final String SAMPLES_FOLDER = "docs/";
